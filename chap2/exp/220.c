...
void FindBestPositions(Book list, int n, int arr[]);
...
int main() {
	...
	int position_nums;
	scanf("%d", &position_nums);
	int positions[position_nums];
	for(int i = 0; i < position_nums; i++)
		scanf("%d", &positions[i]);
	FindBestPositions(list, position_nums, positions);
	return 0;
}
