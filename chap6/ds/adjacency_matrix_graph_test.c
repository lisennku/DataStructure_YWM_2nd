...
int main() {
    ...
    Edge d[g.vertex_nums][g.vertex_nums];
    int path[g.vertex_nums][g.vertex_nums];
    amg_shortest_path_floyd(g, g.vertex_nums, d, path);
    amg_floyd_path_display(g,  g.vertex_nums, d, path);
